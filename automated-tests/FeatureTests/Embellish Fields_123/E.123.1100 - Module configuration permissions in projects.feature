...
Scenario: E.123.1100 - Module configuration permissions in projects
    ...
    When I create a new project named "E.123.1100" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "redcap_val/Project_redcap_val_nodata.xml", and clicking the "Create Project" button
...
Scenario: E.123.600 - View Usage of the external module
    ...
    And I should see a link labeled "E.123.1100" in the dialog box
    When I click on the link labeled "E.123.1100" in the dialog box
