...
Scenario: E.123.300 - Make module discoverable by users
    ...
    When I create a new project named "E.123.300" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "redcap_val/Project_redcap_val_nodata.xml", and clicking the "Create Project" button
