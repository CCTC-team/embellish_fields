Feature: E.123.700 - The system shall support the ability to view field variable name, element type, validation type and action tags in instruments when the corresponding options are enabled in Embellish Fields external module.
  ...
  Scenario: E.123.100 - Disable external module
    ...
    Then I should see a table header and row containing the following values in the logging table:
      ...
      | mm/dd/yyyy hh:mm | test_admin | Disable external module "embellish_fields_v1.1.0" for project                  |                                                                                                                                                                     |
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "embellish_fields_v1.1.0" for project | show-field-variable-name, show-field-element-type, show-field-validation-type                                                                                       |
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "embellish_fields_v1.1.0" for project | show-field-validation-type, include-action-tags                                                                                                                     |
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "embellish_fields_v1.1.0" for project | reserved-hide-from-non-admins-in-project-list, show-field-variable-name, show-field-element-type, show-field-validation-type, include-action-tags, action-tag-regex |
      | mm/dd/yyyy hh:mm | test_admin | Enable external module "embellish_fields_v1.1.0" for project                   |                                                                                                                                                                     |
    ...
    Then I should see a table header and row containing the following values in a table:
      | Time             | User       | Event                                                                          |
      | mm/dd/yyyy hh:mm | test_admin | Disable external module "embellish_fields_v1.1.0" for system                   |
      | mm/dd/yyyy hh:mm | test_admin | Disable external module "embellish_fields_v1.1.0" for project                  |
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "embellish_fields_v1.1.0" for project |
      | mm/dd/yyyy hh:mm | test_admin | Enable external module "embellish_fields_v1.1.0" for project                   |
      | mm/dd/yyyy hh:mm | test_admin | Enable external module "embellish_fields_v1.1.0" for system                    |
