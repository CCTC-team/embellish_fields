Feature: E.123.700 - The system shall support the ability to view field variable name, element type, validation type and action tags in instruments when the corresponding options are enabled in Embellish Fields external module.
  ...
  Scenario: Enable external module in project
    ...
    When I click on the button labeled "Enable a module"
    And I click on the button labeled "Enable" in the row labeled "Embellish fields - v1.0.2"
    Then I should see "Embellish fields - v1.0.2"
    ...
    And I should see "Embellish fields - v1.0.2"
  ...
  Scenario: E.123.100 - Disable external module
    ...
    Then I should see a table header and row containing the following values in the logging table:
      ...
      | mm/dd/yyyy hh:mm | test_admin | Disable external module "embellish_fields_v1.0.2" for project                  |                                                                                                                                                                     |
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "embellish_fields_v1.0.2" for project | show-field-variable-name, show-field-element-type, show-field-validation-type                                                                                       |
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "embellish_fields_v1.0.2" for project | show-field-validation-type, include-action-tags                                                                                                                     |
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "embellish_fields_v1.0.2" for project | reserved-hide-from-non-admins-in-project-list, show-field-variable-name, show-field-element-type, show-field-validation-type, include-action-tags, action-tag-regex |
      | mm/dd/yyyy hh:mm | test_admin | Enable external module "embellish_fields_v1.0.2" for project                   |                                                                                                                                                                     |
    ...
    Then I should see a table header and row containing the following values in a table:
      | Time             | User       | Event                                                                          |
      | mm/dd/yyyy hh:mm | test_admin | Disable external module "embellish_fields_v1.0.2" for system                   |
      | mm/dd/yyyy hh:mm | test_admin | Disable external module "embellish_fields_v1.0.2" for project                  |
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "embellish_fields_v1.0.2" for project |
      | mm/dd/yyyy hh:mm | test_admin | Enable external module "embellish_fields_v1.0.2" for project                   |
      | mm/dd/yyyy hh:mm | test_admin | Enable external module "embellish_fields_v1.0.2" for system                    |
